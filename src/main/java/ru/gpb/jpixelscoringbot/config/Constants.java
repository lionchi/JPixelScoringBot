...
public final class Constants {
    ...
    public static final String UNEXPECTED_TEXT = "Меня этому не обучали";
    ...
    public static final String START_TEST_TEXT = "Супер, вы выбрали {0}. Тебя будет ждать 3 вопроса и у каждого вопроса будет свой таймер. Начнем?";
